...
# DiffNormalized Implementation (for preprocessing)
class DiffNormalized(nn.Module):
    """
    DiffNormalized preprocessing as described in the paper (Section 4.2).
    This enhances model's robustness to motion and background pixels.
    """
    def __init__(self):
